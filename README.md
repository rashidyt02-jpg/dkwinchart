...
<head>
  ...
  <title>Grid Chart with Recent Search</title>
  <style>
    :root{
      --bg: #0b1220;
      --panel: #0f172a;
      --panel-2: #111827;
      --grid: #cbd5e1;      /* হালকা গ্রে গ্রিড লাইন */
      --cell: #ffffff;      
      --cell-alt: #ffffff;  
      --text: #000000;      
      --muted: #6b7280;
    ...
    .wrap{max-width:1100px;margin:40px auto;padding:24px;background:var(--panel);border-radius:20px}
    table{border-collapse:collapse;width:100%; box-shadow:0 0 10px rgba(0,0,0,0.3); border-radius:10px; overflow:hidden;}
    th, td{
      padding:4px;            /* রো চাপানো */
      font-size:14px;         /* মোট font size */
      border:1px solid var(--grid);
      text-align:center;
      vertical-align:middle;
    }
    thead th{background:var(--panel-2);color:var(--head)}
    tbody tr:nth-child(odd) td{background:var(--cell); color:var(--text);}
    tbody tr:nth-child(even) td{background:var(--cell-alt); color:var(--text);}
    .cell-wrap{
      display:flex;
      align-items:center;
    ...
    .nums span{
      font-size:12px;          /* উপরের/নিচের সংখ্যা বড় */
    }
    .mark{font-size:16px;font-weight:bold;color:var(--text)} /* মূল ভ্যালু বড় */
    .eq{font-size:16px;font-weight:bold;color:var(--head)}   /* = সাইন বড় */
...
</style>  <!-- একবারই style শেষ হবে -->

</head>
<body>
<!-- স্ক্রলিং মার্কেট রিসার্চ লেখা -->
...
<!-- Telegram & Register Buttons (ইনলাইন CSS) -->
...
document.addEventListener("contextmenu", function(e){
  e.preventDefault();
  alert("Right click বন্ধ করা আছে 🚫");
});

// কীবোর্ড শর্টকাট নিষিদ্ধ (Ctrl+U, Ctrl+C, Ctrl+Shift+I ইত্যাদি)
document.addEventListener("keydown", function(e){
  // Ctrl+U (View Source)
  if(e.ctrlKey && e.key.toLowerCase() === "u"){
    e.preventDefault();
    alert("View Source বন্ধ 🚫");
  }
  // Ctrl+C (Copy)
  ...
  const customData = {
    "00":"B",   "01":"B",   "02":"S",   "03":"B",   "04":"S",   "05":"S",   "06":"B",   "07":"S",   "08":"S",   "09":"B",
    "10":"S",   "11":"S",   "12":"S",   "13":"S",   "14":"B",   "15":"S",   "16":"B",   "17":"B",   "18":"S",   "19":"S",
    "20":"S",   "21":"B",   "22":"B",   "23":"B",   "24":"S",   "25":"B",   "26":"S",   "27":"B",   "28":"S",   "29":"S",
    "30":"B",   "31":"B",   "32":"B",   "33":"B",   "34":"S",   "35":"S",   "36":"S",   "37":"B",   "38":"S",   "39":"S",
    "40":"B",   "41":"B",   "42":"B",   "43":"B",   "44":"S",   "45":"B",   "46":"B",   "47":"B",   "48":"s",   "49":"S",
    "50":"B",   "51":"B",   "52":"S",   "53":"S",   "54":"B",   "55":"S",   "56":"S",   "57":"S",   "58":"B",   "59":"B",
    "60":"B",   "61":"S",   "62":"S",   "63":"B",   "64":"s",   "65":"B",   "66":"B",   "67":"S",   "68":"s",   "69":"s",
    "70":"B",   "71":"S",   "72":"B",   "73":"S",   "74":"S",   "75":"B",   "76":"B",   "77":"B",   "78":"S",   "79":"S",
    "80":"B",   "81":"S",   "82":"B",   "83":"B",   "84":"B",   "85":"B",   "86":"S",   "87":"B",   "88":"B",   "89":"S",
    "90":"B",   "91":"S",   "92":"S",   "93":"B",   "94":"B",   "95":"B",   "96":"B",   "97":"S",   "98":"B",   "99":"S"
  };
